        ...
        <main class="flex max-w-83.75 w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    ...
                    <li
                        class="flex items-center gap-4 py-2 relative before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A] before:bottom-1/2 before:top-0 before:inset-s-[0.4rem] before:absolute">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span
                                class="flex items-center justify-center rounded-full bg-[#FDFDFC] dark:bg-[#161615] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] w-3.5 h-3.5 border dark:border-[#3E3E3A] border-[#e3e3e0]"
                            >
            ...
            <div
                class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ms-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-e-lg! aspect-335/376 lg:aspect-auto w-full lg:w-109.5 shrink-0 overflow-hidden">
                {{-- Laravel Logo --}}
                <svg
                ...
                {{-- Light Mode 12 SVG --}}
                <svg
                    class="w-md max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] dark:hidden"
                    viewBox="0 0 440 376"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg
                    class="w-md max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] hidden dark:block"
                    viewBox="0 0 440 376"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                >
