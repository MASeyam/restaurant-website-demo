<x-layouts::app :title="__('Dashboard')">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div>
            <h1 class="text-xl font-semibold text-zinc-900 dark:text-zinc-100">Account Dashboard</h1>
            <p class="text-sm text-zinc-600 dark:text-zinc-400">Manage your restaurant orders from here.</p>
        </div>
